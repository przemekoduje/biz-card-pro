...
export default function CameraScreen() {
    ...
    const processCard = async () => {
        ...
        try {
            ...
            // 2.5 Get Location & Reverse Geocode
            let locationCoords = {};
            let locationContext = '';
            ...
            try {
                ...
                if (status === 'granted') {
                    ...
                    if (reverseGeocode.length > 0) {
                        ...
                        locationContext = [address.city, address.street, address.region, address.country]
                            .filter(Boolean)
                            .join(' ');
                        console.log("Location found:", locationContext);
                    }
                }
            } catch (locErr) {
                console.log("Location fetch failed:", locErr);
            }
            ...
            let searchContext = generateSearchContext(cardData);
            if (locationContext) {
